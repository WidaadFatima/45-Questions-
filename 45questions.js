...
//Q5
// Famous quote 2
let famous_person = "Hazrat Muhammaad PBUH";
let message0 = ' "The best among you are those who have the best manners and character." ';
...
let digit4 = 10;
let digit5 = 2;
let digit6 = digit4 - digit5;
console.log(digit6);
// multiplication
let digit7 = 2;
let digit8 = 4;
let digit9 = digit7 * digit8;
console.log(digit9);
// division
let digit10 = 32;
let digit11 = 4;
let digit12 = digit10 / digit11;
console.log(digit12);
//Q8
// Number eight
console.log(5 + 3);
...
//Q9
// Favorite number
let favourite_number = 14;
let message1 = `Hey guys, you know my favourite number is ${favourite_number}.`;
...
const Cars = ["Civic", "Fortuner", "Hillux"];
...
//Q14
// Guest list
let guest_list = ["Rabail", "Simle", "Simra"];
...
// Task 2
let changed_guestlist = ["Rabail", "Simle", "Hijab"];
// Task 3
...
// Task 2
function removeGuestsUntilTwoRemain(guestList) {
...
// Seeing the world
// Task 1
let fivePlaces = ["Makkah", "Madina", "Norway", "Maldives", "Disney Land"];
// Copying original array to print later 
let original_fivePlaces = [...fivePlaces];
// Task 2
...
// Task 5
let sortedReverse_fivePlaces = [...fivePlaces].sort((a, b) => b.localeCompare(a));
...
let languages = ["Urdu", "English", "Sindhi", "Arabic"];
...
const mysteryBox = [item1, item2, item3, item4, item5];
...
else if (age0 == 65 || age > 65) {
    console.log("The person is a elder.");
}
// Q29
// Favourite fruits
// Task 1
let favorite_fruits = ["Pomegranate", "Strawberry", "Apricot"];
// Task 2
...
// Q30
// Hello admin
let usernames = ["Zaima", "Laiba", "Zainab", "Admin", "Ayeza"];
...
// Checking usernames
// Task 1
let current_users = ["Aimalnoor", "Sheikhawidaad", "widaad.f", "ShakeelKashfi", "Ayan.Ali"];
// Task 2
let new_users = ["S.brothers", "SheikhaWidaad", "Widaad.f", "IamWadi", "Nooor."];
...
// Pizzas
// Task 1
let favorite_pizzas = ["Crust Pizza", "Fajita Pizza", "Malai boti Pizza"];
...
// Animal
// Task 1
let animals = ["Kangaroo", "Frog", "Rabbit"];
...
function describeCity(cityName, country = 'Australia') {
...
let great_magicians_copy = make_great_copy(original_magicians);
